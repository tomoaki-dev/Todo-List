...
public class FolderActivity extends FragmentActivity implements AlertDialogFragment.NoticeDialogListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(newName.isEmpty()) {
                    Toast.makeText(FolderActivity.this, "名前を入力してください", Toast.LENGTH_SHORT).show();
